...
def rust_coverage(
    ...
    if workspace is not None:
        ...
        # module's own .bazelrc -- left unmodified on purpose. score_logging/score_persistency
        # still fail there on a stale @score_baselibs label (exit_code 2, no coverage).
