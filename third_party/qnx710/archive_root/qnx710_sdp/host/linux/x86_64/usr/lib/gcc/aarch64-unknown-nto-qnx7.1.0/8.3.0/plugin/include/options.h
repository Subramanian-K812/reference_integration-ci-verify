...
#endif
#ifdef GENERATOR_FILE
extern int cxxstdlib;
#else
  int x_cxxstdlib;
#define cxxstdlib global_options.x_cxxstdlib
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_mharden_sls_ = 1199,                   /* -mharden-sls= */
  ...
  OPT_moverride_ = 1205,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1206,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1207,          /* -msign-return-address= */
  OPT_mstrict_align = 1208,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1209,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1210,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1211,                     /* -mtls-size= */
  OPT_mtune_ = 1212,                         /* -mtune= */
  OPT_mverbose_cost_dump = 1213,             /* -mverbose-cost-dump */
  OPT_n = 1214,                              /* -n */
  OPT_no_canonical_prefixes = 1215,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1216,              /* -no-integrated-cpp */
  OPT_no_pie = 1217,                         /* -no-pie */
  OPT_nocpp = 1218,                          /* -nocpp */
  OPT_nodefaultlibs = 1219,                  /* -nodefaultlibs */
  /* OPT_nopie = 1220, */                    /* -nopie */
  ...
  OPT_pthread = 1245,                        /* -pthread */
  OPT_quiet = 1246,                          /* -quiet */
  OPT_r = 1247,                              /* -r */
  OPT_rdynamic = 1248,                       /* -rdynamic */
  OPT_remap = 1249,                          /* -remap */
  OPT_rpath_link = 1250,                     /* -rpath-link */
  OPT_rpath_link_ = 1251,                    /* -rpath-link= */
  OPT_rpath_ = 1252,                         /* -rpath= */
  OPT_s = 1253,                              /* -s */
