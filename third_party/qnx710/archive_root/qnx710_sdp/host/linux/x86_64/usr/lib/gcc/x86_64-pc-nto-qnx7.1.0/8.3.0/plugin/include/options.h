...
enum opt_code
{
  ...
  OPT_stdlib_ = 1469,                        /* -stdlib= */
  OPT_symbolic = 1470,                       /* -symbolic */
  OPT_t = 1471,                              /* -t */
  OPT_time = 1472,                           /* -time */
  OPT_time_ = 1473,                          /* -time= */
  OPT_traditional = 1474,                    /* -traditional */
  OPT_traditional_cpp = 1475,                /* -traditional-cpp */
  OPT_trigraphs = 1476,                      /* -trigraphs */
  OPT_u = 1477,                              /* -u */
  OPT_undef = 1478,                          /* -undef */
  OPT_v = 1479,                              /* -v */
  OPT_version = 1480,                        /* -version */
  OPT_w = 1481,                              /* -w */
  OPT_wrapper = 1482,                        /* -wrapper */
  OPT_x = 1483,                              /* -x */
  OPT_z = 1484,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
